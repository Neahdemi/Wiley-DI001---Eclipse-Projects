...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	public void showMenu() {
		...
		System.out.println("7. Search employees by Departement name");
	...
	public void performMenu(int choice) {
		...
		case 7:
			...
			Collection<Employee> theEmps = employeeService.getEmployeesByDept(dept);
			//when no employee added, array of size 0 outputted so use this
			if(theEmps.size()>0)
